...
public class BigQueryPartitionServiceTest {
  ...
  private BigQueryPartitionService generator;

  @Before
  public void init() {
    generator = new BigQueryPartitionService(bigQueryMetastore, extractionService, sourceDBName, sourceTableName,

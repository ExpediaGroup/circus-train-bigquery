...
public class HivePartitionServiceTest {
  ...
  @Before
  public void init() {
    hivePartitionService = new HivePartitionService(table, metastore, service, factory);
  }
  ...
  public void generateTest() {
    ...
    List<Partition> partitions = hivePartitionService.generate(partitionKey, rows);
